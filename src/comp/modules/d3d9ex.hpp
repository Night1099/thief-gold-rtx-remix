...
namespace comp
{
	...
	private:
		...
		private:
			// Submit worldrep geometry + engine lights into the ray-traced scene.
			// Must run BEFORE any UI draw (UI triggers Remix RTX injection; draws
			// after it are raster-composited, not path-traced).

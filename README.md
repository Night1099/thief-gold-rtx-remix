...
2. [**RTX Remix runtime 1.5.2+**](https://github.com/NVIDIAGameWorks/rtx-remix/releases/tag/remix-1.5.2) ([download](https://github.com/NVIDIAGameWorks/rtx-remix/releases)): unzip the **entire** release into the game dir.
